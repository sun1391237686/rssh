...
const en = {
  ...
  "settings.shell.sftp_browser": "SFTP Browser",
  "settings.shell.sftp_follow_cwd": "Follow current directory",
  "settings.shell.sftp_follow_cwd_desc": "When on, the SFTP browser on this tab follows the connected terminal's current directory.",
